...
public class NotificationDetailsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String receiver = intent
        		.getStringExtra(Constants.NOTIFICATION_RECEIVER);
        String sender = intent
        		.getStringExtra(Constants.NOTIFICATION_SENDER);
        String groupId = intent
        		.getStringExtra(Constants.NOTIFICATION_GROUP_ID);
        

        Log.d(LOGTAG, "notificationId=" + notificationId);
        Log.d(LOGTAG, "notificationTitle=" + notificationTitle);
        Log.d(LOGTAG, "notificationMessage=" + notificationMessage);
        Log.d(LOGTAG, "receiver=" + receiver);
        Log.d(LOGTAG, "sender=" + sender);
        Log.d(LOGTAG, "groupId=" + groupId);
