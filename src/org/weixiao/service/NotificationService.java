...
import org.weixiao.client.PhoneStateChangeListener;
import org.weixiao.client.XmppManager;
import org.weixiao.receiver.ConnectivityReceiver;
import org.weixiao.receiver.NotificationReceiver;
...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "org.weixiao.service.NotificationService";
    ...
    private void registerNotificationReceiver() {
        ...
        filter.addAction(Constants.ACTION_SEND_NOTIFICATION);
        filter.addAction(Constants.ACTION_USER_LOGIN);
        filter.addAction(Constants.ACTION_USER_REGISTER);
        filter.addAction(Constants.ACTION_CREATE_GROUP);
        filter.addAction(Constants.ACTION_USER_GROUP_LIST);
        filter.addAction(Constants.ACTION_CONNECT_LOGIN);
        filter.addAction(Constants.ACTION_NOTIFICATION_LIST_4_GROUP);
        filter.addAction(Constants.ACTION_SEND_MESSAGE_4_GROUP);
        filter.addAction(Constants.ACTION_SEARCH_GROUP);
        filter.addAction(Constants.ACTION_JOIN_GROUP);
        filter.addAction(Constants.ACTION_GROUP_REQUEST_LIST);
        filter.addAction(Constants.ACTION_HANDLE_GROUP_REQUEST);
        
        filter.addAction(Constants.ACTION_GROUP_MEMBER_LIST);
        filter.addAction(Constants.ACTION_CHANGE_PUSHABLE_4_GROUP);
        filter.addAction(Constants.ACTION_OUT_MEMBER_4_GROUP);
